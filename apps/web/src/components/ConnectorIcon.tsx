...
/**
 * Brand icon for a data connector, keyed by connector name. Everything stays
 * currentColor so it follows the surrounding text/theme. Unknown connectors
 * fall back to a generic plug, so future connectors degrade gracefully
 * instead of breaking the pickers.
 */
